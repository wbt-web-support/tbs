    ...
    try {
      ...
      if (subcategoriesResponse.ok) {
        ...
        if (subcategories && subcategories.length > 0) {
          // Subcategories exist - check if FULFILLMENT machines exist
          ...
          // If subcategories exist, go directly to machines view (even if no FULFILLMENT machines yet)
          // This allows users to use subcategories created in Growth
