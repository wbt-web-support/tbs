          ...
          <CardContent className="p-8">
            <div className="text-center space-y-6">
              <div className="flex justify-center">
                <div className={`w-16 h-16 bg-${engineColor}-600 rounded-full flex items-center justify-center`}>
                  <Sparkles className="h-8 w-8 text-white" />
                </div>
              </div>
              <div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                  Welcome to {engineName} Engine
                </h3>
                <p className="text-base text-gray-600 leading-relaxed max-w-2xl mx-auto">
                  This is {engineName} Engine - here you can define and manage your {engineName.toLowerCase()} machine process. 
                  We've analysed your company data and our AI assistant can help map your {engineName.toLowerCase()} process. 
                  Let's get started!
                </p>
              </div>
              <div className="flex justify-center pt-4">
                <Button
                  ...
                  className={`bg-${engineColor}-600 hover:bg-${engineColor}-700 text-white shadow-md px-8 py-6 text-base`}
                  size="lg"
                >
      ...
      <Card className="border border-gray-200 max-w-3xl w-full mx-auto bg-gray-50">
        <CardHeader className="pb-6">
          ...
          <CardDescription className="text-gray-600 mt-2">
            Choose which services you want to create {engineName.toLowerCase()} machines for. 
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-200">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                ...
                className={`bg-${engineColor}-600 hover:bg-${engineColor}-700 text-white`}
              >
                {isAddingService ? (
          ...
          <div className="flex justify-end pt-6 border-t border-gray-200">
            <Button
              ...
              className={`bg-${engineColor}-600 hover:bg-${engineColor}-700 text-white px-8`}
            >
              {isContinuing ? (
                <>
