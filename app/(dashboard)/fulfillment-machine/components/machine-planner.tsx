      ...
      try {
        ...
        if (result.data) {
          try {
            ...
            if (onDataChange) onDataChange();
            toast.success("Fulfillment Machine generated and saved!");
          } catch (saveErr) {
        ...
        const errorMessage = err.message || 'Failed to generate Fulfillment Machine content';
  ...
  return (
    <div className="space-y-5">
      ...
      {false && !(machineData?.questions_completed && machineData?.ai_assisted) && (
        <div className="flex items-center justify-between p-4 bg-purple-50 border border-purple-200 rounded-lg flex-wrap gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">
                Let AI analyze your answers and map your fulfillment process
              </p>
            </div>
          </div>
          ...
          {!hasContent ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-600 mb-6">
                Click "Let AI Help Map This" to generate your fulfillment machine from your answers
              </p>
            </div>
          ) : (
