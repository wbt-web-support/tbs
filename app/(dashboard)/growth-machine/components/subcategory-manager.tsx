    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-500px)] py-8">
      <Card className="border border-gray-200 max-w-4xl w-full mx-auto bg-gray-50">
        ...
        <CardContent className="space-y-6">
          ...
          {isAdding && (
            <div className="p-4 bg-white border-2 border-blue-200 border-dashed rounded-lg">
              <div className="space-y-3">
                <div>
                  <label className="text-sm font-medium text-gray-700 block mb-1">
                    Service
                  ...
                  <select
                    ...
                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500"
                    disabled={isSaving}
                  >
