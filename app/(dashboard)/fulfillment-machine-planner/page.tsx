...
export default function FulfillmentMachinePlannerPage() {
  ...
  const handleSaveAll = async () => {
    ...
    try {
      ...
      console.error("Error saving fulfillment machine:", err);
      setError(err.message || "Failed to save fulfillment machine");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="max-w-[1440px] mx-auto">
      <div className="mb-5">
        <h1 className="text-xl sm:text-2xl font-semibold text-gray-900">Fulfillment Machine Planner</h1>
        <p className="text-sm text-gray-500 mt-1">
          Define and manage your business fulfillment machine
        </p>
      </div>
