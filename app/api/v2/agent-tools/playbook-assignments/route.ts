/**
 * Playbook Assignments Tool API for ElevenLabs Voice Agent
 *
 * Fetches playbook ownership assignments.
...
const TOOL_KEY = "playbook_assignments";
...
export async function POST(req: Request) {
  ...
  // Playbook assignments are platform-wide
