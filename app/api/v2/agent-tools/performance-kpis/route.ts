/**
 * Performance KPIs Tool API for ElevenLabs Voice Agent
 *
 * Fetches performance metrics and KPIs.
...
const TOOL_KEY = "performance_kpis";
...
export async function POST(req: Request) {
  ...
  // Performance KPIs are platform-wide
