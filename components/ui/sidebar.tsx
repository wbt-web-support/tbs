...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, ...props }, ref) => {
  ...
  // This is a controlled component if open and onOpenChange are provided
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ref={ref}
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-[[data-sidebar=sidebar]]:lg:pl-[--sidebar-width]",
            className
          )}
          {...props}
        />
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <div ref={ref} className="flex h-full w-full flex-col bg-white" {...props} />
        </SheetContent>
      </Sheet>
    )
  }
  ...
  return (
    <div
      ...
      data-mobile={isMobile}
      className={cn(
        "group peer hidden md:block text-sidebar-foreground transition-[width] duration-200 ease-linear bg-white h-screen",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:mb-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:mr-2 md:peer-data-[variant=inset]:mt-12 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-0 overflow-auto group-data-[collapsible=icon]:overflow-hidden px-[10px]",
          className
        )}
        {...props}
      />
