 ...
 */
export function shouldGenerateTitle(currentTitle: string, messageCount?: number): boolean {
 ...
 */
function createTitlePrompt(options: TitleGenerationOptions): string {
 ...
 */
async function generateWithGemini(options: TitleGenerationOptions): Promise<TitleGenerationResult> {
  try {
 ...
 */
function generateFallbackTitle(options: TitleGenerationOptions): TitleGenerationResult {
 ...
 */
export async function generateChatTitle(options: TitleGenerationOptions): Promise<TitleGenerationResult> {
  try {
    // Try Gemini first
